def load_stratified_dataset(path, labels, samples_per_label):
    """
    ...
    for label in df[labels].unique():
        ...
        tmp, _ = train_test_split(tmp, shuffle=True, test_size=abs(1-samples_per_label/(tmp.shape[0]-0.001)), random_state=42)
        l.append(tmp)
